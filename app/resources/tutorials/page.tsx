...
export default function TutorialsPage() {
  const tutorialSections = [
    ...
    {
      title: "Integrations",
      tutorials: ["How to connect WhatsApp and Instagram for messaging"],
    },
  ];
        ...
        <div className="mx-auto space-y-12">
          {tutorialSections.map((section, sectionIndex) => (
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl md:text-3xl font-bold text-foreground border-b border-gray-200 pb-4">
                {section.title}
              </h2>
