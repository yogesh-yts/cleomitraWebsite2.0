import { SliderData } from "@/components/sections/ProductShowcase";

export const whatsappSliderData: SliderData[] = [
  {
    id: 1,
...
export const emailSliderData: SliderData[] = [
  {
    id: 1,
...
export const inventorySliderData: SliderData[] = [
  {
    id: 1,
...
export const socialMediaSliderData: SliderData[] = [
  {
    id: 1,
